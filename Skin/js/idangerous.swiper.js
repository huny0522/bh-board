    ...
    _this.init = function (force, forceCalcSlides) {
        ...
        if (params.slidesPerView === 'auto') {
            ...
            if (params.calculateHeight) {
				...
				var temp = params.spaceBetween * (params.slidesPerView - 1) / params.slidesPerView;
                slideHeight = isH ? _this.height : _this.height / params.slidesPerView - temp + params.spaceBetween;
                if (params.roundLengths) slideHeight = Math.ceil(slideHeight);
                wrapperHeight = isH ? _this.height : _this.slides.length * slideHeight;
            }
			var temp = params.spaceBetween * (params.slidesPerView - 1) / params.slidesPerView;
            slideWidth = isH ? _this.width / params.slidesPerView - temp + params.spaceBetween : _this.width;
            ...
            for (i = 0; i < _this.slides.length; i++) {
                ...
                if (parseFloat(slideWidth) > 0 && (!params.cssWidthAndHeight || params.cssWidthAndHeight === 'height')) {
                    if(params.mode == 'horizontal') {
                        _this.slides[i].style.width = (slideWidth - params.spaceBetween ) + 'px';
                        _this.slides[i].style.marginRight = params.spaceBetween + 'px';
                    }else{
                ...
                if (parseFloat(slideHeight) > 0 && (!params.cssWidthAndHeight || params.cssWidthAndHeight === 'width')) {
                    if(params.mode == 'horizontal'){
                        ...
                        _this.slides[i].style.height = ( slideHeight - params.spaceBetween ) + 'px';
                        _this.slides[i].style.marginBottom = params.spaceBetween + 'px';
                    }
                }
            }
